...
const About = () => {
  return (
    <section className="container mt-10 md:mt-14 lg:mt-20">
      ...
      <div className="flex flex-col-reverse gap-8 md:gap-14 lg:flex-row lg:items-start">
        <ImageSection
          images={[
      ...
      <div className="flex flex-col gap-16 pt-10 md:pt-14 lg:flex-row lg:items-start lg:pt-20">
        <TextSection
          title="The team"
          paragraphs={[
...
export function TextSection({
  ...
  return (
    <div className="flex-1 space-y-4 text-lg font-medium md:space-y-6">
      ...
      <div className="text-muted-foreground max-w-[600px] space-y-6">
